...
from backend.app.pipelines.runner import router as runner_router
...
from backend.app.proxy.router import router as proxy_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(runner_router, prefix="/api/pipelines", tags=["runner"])
